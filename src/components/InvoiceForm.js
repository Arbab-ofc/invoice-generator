...
const nanoidNumbersOnly = customAlphabet('0123456789', 5);
...
class InvoiceForm extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      currency: '$',
      currentDate: '',
      invoiceNumber: nanoidNumbersOnly(),
      dateOfIssue: '',
      billTo: '',
      billToEmail: '',
      billToAddress: '',
      ...
      <Row>
        <Col md={8} lg={9}>
          <Card className="p-4 p-xl-5 my-3 my-xl-4">
            ...
            <Form.Control placeholder="Thanks for your business! ~ Arbab Arshad ❤️" name="notes" value={this.state.notes} onChange={(event) => this.editField(event)} as="textarea" className="my-2" rows={1}/>
          </Card>
        </Col>
        <Col md={4} lg={3}>
